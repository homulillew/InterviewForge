...
python -m interview_forge corpus ingest "$project_root/examples/materials/redis-interview.png" \
  --corpus "$output_root/corpus.sqlite3"
...
python -m interview_forge start \
  ...
  --library "$library_path" --corpus "$output_root/corpus.sqlite3" --style corpus \
